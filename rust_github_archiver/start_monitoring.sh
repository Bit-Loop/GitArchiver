...
: "${JWT_SECRET:?Set JWT_SECRET to a 32+ character random secret before starting}"
: "${ADMIN_PASSWORD:?Set ADMIN_PASSWORD to a strong random admin password before starting}"
